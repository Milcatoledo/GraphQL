...
module.exports = {
    Mutation: {
        ...
        try {
            ...
            try { console.error('Register resolver error:', error && (error.stack || error)); } catch (e) { /* ignore logging errors */ }
        ...
        try {
            ...
            try { console.error('Login resolver error:', error && (error.stack || error)); } catch (e) { /* ignore */ }
